    ...
    <div class="">
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          @php $ratenum = number_format($ratings_avg) @endphp
          ...
          <div class="col-md-10">
            ...
            @if($products->qty > 0)
            <button type="button" class="btn btn-success addToCartBtn me-3 float-start">Add to Cart <i class="fa fa-heart"></i></button>
            @endif
